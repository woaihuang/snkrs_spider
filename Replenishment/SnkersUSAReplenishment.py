...
class GetChinaMsg():
    ...
    def GetHtml(self):
        ...
        while lensnkrs < 200:
            reql = requests.get('{}'.format('https://api.nike.com/snkrs/content/v1/?&country=US&language=en&offset=0&orderBy=published'), timeout=5)
    ...
    def GetMsg(self):
        ...
        for i in range(len(ShoesList)):
            ...
            if 'title' in ShoesList[i]['product'] and ShoesSku not in ['BQ4800-100', 'CD9329-001', 'AV4052-100', 'CK1905-100', 'CK1907-600', 'AO3189-001', 'AO3189-100']:
                ...
                ReplenishmentList = self.Rep_Usa_cur1.fetchall()
                ...
                if ReplenishmentList:
                    ...
                    if len(skustr) > 1:
                        ...
                        try:
                            self.Rep_Usa_cur1.execute(sql_1)
                        ...
                        try:
                            self.Rep_Usa_cur.execute(sql_7)
                        except Exception as E:
                            print(E)

                        Grab_judgment = self.Rep_Usa_cur.fetchall()
        ...
        if len(ShoeTitle) > 0:
            ...
            self.Rep_Usa_cur1.close()
            self.Rep_Usa_conn1.close()
            print('发送保存成功')
