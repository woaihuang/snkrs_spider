            ...
            if ShoesList[i]['id'] not in OldPublishTime:
                ...
                if 'title' not in ShoesList[i]['product']:
                    ...
                    if ShoesSku not in ['BQ4800-100', 'CD9329-001', 'AV4052-100', 'CK1905-100', 'CK1907-600',
                        ...
                        with open('/root/snker_crawler/img/beauty_3.jpg', 'wb') as f:
                            f.write(r.content)

                        localfile = '/root/snker_crawler/img/beauty_3.jpg'
                        ...
                        sql_1 = """INSERT INTO monitor_result (title, sku, distributionchannels, replenishmenttype, pushtime, picurl, `status`, createtime, distributionid, linkurl, productid) VALUES("{}", '{}', 'SNKRS英国', '{}', '{}', '{}', 2, now(), 3, '{}', '{}')""".format(
                        ...
                        if len(Grab_judgment) == 0:
                            ...
                            sql = """INSERT INTO monitor_result (title, sku, distributionchannels, replenishmenttype, pushtime, picurl, `status`, createtime, distributionid, linkurl, productid, sortnum, pushid) VALUES("{}", '{}', 'SNKRS英国', '{}', '{}', '{}', 0, now(), 3, '{}', '{}', 4, {})""".format(
